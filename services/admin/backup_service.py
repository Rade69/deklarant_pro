...
class BackupService:
    ...
    def restore_pg_backup_python(self, backup_path: str,
        ...
        Args:
            backup_path: Put do .sql fajla
            create_backup_before: Kreiraj bekap prije restore-a
        ...
        try:
            ...
            with conn.cursor() as cur, open(backup_file, 'r', encoding='utf-8') as f:
                sql = f.read()
