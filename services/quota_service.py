...
def ensure_tables():
    """Kreira tabele ako ne postoje (idempotentno). Ako nema privilegija, oslanja se na postojeće."""
    ...
    try:
        ...
        logger.debug("ensure_tables preskočeno (pretpostavljam da tabele već postoje): %s", e)
