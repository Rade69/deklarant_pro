"""
Servis za čuvanje i učitavanje radnih nacrta deklaracije (DeclarationDraft)
u Deklarant Pro XML formatu (`.xml`, root `<DeklarantProDraft>`).

Razlikuje se od ASYCUDA XML exporta — ovo je interni format koji
serijalizuje cijeli DeclarationDraft (zaglavlje, fakture, naimenovanja)
da bi korisnik mogao sačuvati i nastaviti rad kasnije.
"""
