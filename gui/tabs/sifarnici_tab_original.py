...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("sifarnici_tab.log"), logging.StreamHandler()],
)
...
class SifarniciTab(QWidget):
    ...
    def _create_sidebar(self) -> QWidget:
        ...
        # Header — isti stil kao Admin tab
        ...
        # Categories list — isti QSS kao AdminView QListWidget u admin_tab.qss
    ...
    def _create_header_bar(self) -> QWidget:
        ...
        header = QWidget()
        header.setStyleSheet("background: #f8f8f8; border-bottom: 1px solid #ddd;")
        layout = QHBoxLayout(header)
        layout.setContentsMargins(20, 10, 20, 10)

        icon = QLabel("≡")
        icon.setStyleSheet("font-size: 18px; color: #666;")
