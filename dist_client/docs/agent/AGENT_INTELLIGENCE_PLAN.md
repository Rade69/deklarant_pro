...
- `SHOW_WEAK` — slabiji, ali još prihvatljiv prijedlog; UI ga prikazuje, ali ga “Prihvati jake” preskače
...
1. Odlučiti da li score treba prikazati korisniku ili ostaje interni debug signal.
2. Ako se prikazuje, dodati ga prvo u kopirani izvještaj, ne u glavni UI.
