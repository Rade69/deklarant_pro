...
class TestLeburicExcel:
    ...
    def test_detect(self):
        ...
        from importers.vendors.leburic.leburic_pekabesko_importer import detect_leburic_pekabesko_excel
        assert detect_leburic_pekabesko_excel(str(self.XLSX))

    def test_item_count(self):
        _skip_if_missing(self.XLSX)
        from importers.vendors.leburic.leburic_pekabesko_importer import parse_leburic_pekabesko_excel
...
class TestLeburicPdf21:
    ...
    def test_detect(self):
        ...
        from importers.vendors.leburic.leburic_pekabesko_importer import detect_leburic_pekabesko_pdf
...
class TestImamogluPackingList:
    ...
    def test_detect(self):
        _skip_if_missing(self.XLSX)
        from importers.vendors.imamoglu.imamoglu_excel_importer import detect_imamoglu_packing_list
        assert detect_imamoglu_packing_list(str(self.XLSX))

    def test_item_count(self):
        _skip_if_missing(self.XLSX)
        from importers.vendors.imamoglu.imamoglu_excel_importer import parse_imamoglu_packing_list
