...
This project is indexed by GitNexus as **deklarant_pro** (54058 symbols, 81143 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
