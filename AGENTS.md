...
This project is indexed by GitNexus as **deklarant_pro** (39081 symbols, 61451 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
