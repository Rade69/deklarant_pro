...
This project is indexed by GitNexus as **deklarant_pro** (39136 symbols, 61530 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
