...
This project is indexed by GitNexus as **deklarant_pro** (35327 symbols, 57851 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
