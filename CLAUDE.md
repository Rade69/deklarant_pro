...
This project is indexed by GitNexus as **deklarant_pro** (15065 symbols, 22608 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
