...
This project is indexed by GitNexus as **deklarant_pro** (48486 symbols, 74856 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
